...
const ProjectCard3= ({ title, des, src,Tech }) => {
  return (
        ...
        <div>
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <a href='https://github.com/ayushgupta1324/monday.com-clone' target='_blanck' className="project-github-link text-xl w-9 h-9 rounded-full bg-black inline-flex justify-center items-center text-gray-400 hover:text-designColor duration-300 cursor-pointer">
                <BsGithub />
              </a>
              <a href='https://teamsunday.netlify.app/' target='_blanck' className="project-deployed-link text-xl w-9 h-9 rounded-full bg-black inline-flex justify-center items-center text-gray-400 hover:text-designColor duration-300 cursor-pointer">
                <FaGlobe />
              </a>
            </div>
          </div>
